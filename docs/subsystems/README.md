...
| [social.md](social.md) | publishing under the operator's own name: the merged target catalog, application credentials versus account grants, and the approval ask inside the publishing operation |
