...
describe('ui-settings-models apply', () => {
  ...
  it('reads a remote browser\'s acknowledgement from the Host, like a local one', async () => {
    // Upstream keeps a non-loopback page's settings process-local. This fork
    // serves the UI behind its own password gate and persists to the Harness
    // home for every browser, so the off-loopback read is the ordinary one.
