...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  PublishedOutput: 'published deliverable record is owned by packages/host/outputs/README.md',
  SocialProvider: 'provider registration is owned by packages/social/social/README.md',
  SocialTarget: 'one place the agent can post to is owned by packages/social/social/README.md',
  SocialPostRequest: 'publication request is owned by packages/social/social/README.md',
  SocialPostResult: 'publication outcome is owned by packages/social/social/README.md',
