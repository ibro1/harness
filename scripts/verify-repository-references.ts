...
// `deploy/STATE.md` is this fork's own record of where it stands, and naming
// the fork's commits is what it is for; the rule exists so maintained docs do
// not pin commits a shallow clone of the upstream repository cannot resolve.
const excludedPrefixes = ['vendor/', '.agents/notes/archived/', 'deploy/STATE.md']
